      ...
      <section class="section" v-for="(pedido, index) in pedidos" :key="index">
        ...
        <b-table
            ...
            <b-table-column label="Preço" :td-attrs="columnTdAttrs" left v-slot="props">
                <span>
                    {{ props.row.preco | f-currency }}
                </span>
            </b-table-column>

            <b-table-column field="instituicao" label="Instituição" :td-attrs="columnTdAttrs" centered v-slot="props">
              <div v-if="props.row.instituicao">
                {{ props.row.instituicao.nome }}
              </div>
            </b-table-column>
        ...
        <br>
        <h1 class="subtitle"><b>Total do pedido:</b> {{pedido.valorTotal | f-currency}}</h1>
        <br>
        <br>
